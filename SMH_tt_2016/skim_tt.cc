...
int main(int argc, char** argv) {
    ...
    for (int iEntry = 0; iEntry < tree->GetEntries() ; iEntry++)
    {
        ...
        if (isMC && tree->t2ZTTGenMatching==5 && tree->t2DecayMode==0) dau2=dau2*0.994;
        else if (isMC && tree->t2ZTTGenMatching==5 && tree->t2DecayMode==1) dau2=dau2*0.995;
        else if (isMC && tree->t2ZTTGenMatching==5 && tree->t2DecayMode==10) dau2=dau2*1.000;
        ...
        if (isMC && tree->t1ZTTGenMatching==5 && tree->t1DecayMode==0) dau1=dau1*0.994;
        else if (isMC && tree->t1ZTTGenMatching==5 && tree->t1DecayMode==1) dau1=dau1*0.995;
        else if (isMC && tree->t1ZTTGenMatching==5 && tree->t1DecayMode==10) dau1=dau1*1.000;
