...
// Thu May 21 12:55:54 2020 by ROOT version 6.10/09
...
#ifndef HTauTauTree_eeet_h
#define HTauTauTree_eeet_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         e1_t_DR;
   Float_t         e1_t_Mass;
   Float_t         e1_t_doubleL1IsoTauMatch;
   ...
   Float_t         e2_t_DR;
   Float_t         e2_t_Mass;
   Float_t         e2_t_doubleL1IsoTauMatch;
   ...
   Float_t         e3_t_DR;
   Float_t         e3_t_Mass;
   Float_t         e3_t_doubleL1IsoTauMatch;
   ...
   TBranch        *b_e1_t_DR;   //!
   TBranch        *b_e1_t_Mass;   //!
   TBranch        *b_e1_t_doubleL1IsoTauMatch;   //!
   ...
   TBranch        *b_e2_t_DR;   //!
   TBranch        *b_e2_t_Mass;   //!
   TBranch        *b_e2_t_doubleL1IsoTauMatch;   //!
   ...
   TBranch        *b_e3_t_DR;   //!
   TBranch        *b_e3_t_Mass;   //!
   TBranch        *b_e3_t_doubleL1IsoTauMatch;   //!
   ...
   // methods
   HTauTauTree_eeet (TTree* tree); //ctor
   ~HTauTauTree_eeet();
...
HTauTauTree_eeet::HTauTauTree_eeet (TTree* tree)
{
    Init(tree);
}

HTauTauTree_eeet::~HTauTauTree_eeet() {}

void HTauTauTree_eeet::Init(TTree* tree)
{
   // Set object pointer
   ...
   _tree->SetBranchAddress("e1_t_doubleL1IsoTauMatch", &e1_t_doubleL1IsoTauMatch, &b_e1_t_doubleL1IsoTauMatch);
   ...
   _tree->SetBranchAddress("e2_t_doubleL1IsoTauMatch", &e2_t_doubleL1IsoTauMatch, &b_e2_t_doubleL1IsoTauMatch);
   ...
   _tree->SetBranchAddress("e3_t_DR", &e3_t_DR, &b_e3_t_DR);
   _tree->SetBranchAddress("e3_t_Mass", &e3_t_Mass, &b_e3_t_Mass);
   _tree->SetBranchAddress("e3_t_doubleL1IsoTauMatch", &e3_t_doubleL1IsoTauMatch, &b_e3_t_doubleL1IsoTauMatch);
...
Int_t HTauTauTree_eeet::GetEntry(int entry)
{
    return _tree->GetEntry(entry);
}

Long64_t HTauTauTree_eeet::GetEntries()
{
    return _tree->GetEntries();
}

TTree* HTauTauTree_eeet::GetTree()
{
    return _tree;
}
