...
float mjj;
float passMu22eta2p1, passTkMu22eta2p1, passMu19Tau20, passMu19Tau20SingleL1,passMu20HPSTau27;
float matchMu22eta2p1_1, matchTkMu22eta2p1_1, matchMu19Tau20SingleL1_1, matchMu19Tau20SingleL1_2, matchMu19Tau20_1, matchMu19Tau20_2, matchMu20HPSTau27_1, matchMu20HPSTau27_2;
float filterMu22eta2p1_1, filterTkMu22eta2p1_1, filterMu19Tau20SingleL1_1, filterMu19Tau20SingleL1_2, filterMu19Tau20_1, filterMu19Tau20_2, filterMu20HPSTau27_1, filterMu20HPSTau27_2;
...
void fillTree(TTree *Run_Tree, HTauTauTree_mt *tree, int entry_tree, int recoil, bool ismc, bool isembedded){
    ...
    trg_singlemuon_22=tree->singleIsoMu22Pass && tree->mMatchesIsoMu22Path && tree->mMatchesIsoMu22Filter && tree->mPt>23;
    trg_singlemuonTk_22=tree->singleIsoTkMu22Pass && tree->mMatchesIsoTkMu22Path && tree->mMatchesIsoTkMu22Filter && tree->mPt>23;
    trg_singlemuon_22_eta2p1=tree->singleIsoMu22eta2p1Pass && tree->mMatchesIsoMu22eta2p1Path && tree->mMatchesIsoMu22eta2p1Filter && tree->mPt>23;
    trg_singlemuonTk_22_eta2p1=tree->singleIsoTkMu22eta2p1Pass && tree->mMatchesIsoTkMu22eta2p1Path && tree->mMatchesIsoTkMu22eta2p1Filter && tree->mPt>23;
    trg_crossmuon_mu19tau20=tree->singleMu19eta2p1LooseTau20Pass && tree->mMatchesIsoMu19Tau20Path && tree->tMatchesIsoMu19Tau20Path && tree->mMatchesIsoMu19Tau20Filter && tree->tMatchesIsoMu19Tau20Filter && tree->mPt>20 && tree->mPt<23 && fabs(tree->tEta)<2.1 && tree->tPt>25;
    trg_crossmuon_mu19tau20_singleL1=tree->singleMu19eta2p1LooseTau20singleL1Pass && tree->mMatchesIsoMu19Tau20SingleL1Path && tree->tMatchesIsoMu19Tau20SingleL1Path && tree->mMatchesIsoMu19Tau20SingleL1Filter && tree->tMatchesIsoMu19Tau20SingleL1Filter && tree->mPt>20 && tree->mPt<23 && fabs(tree->tEta)<2.1 && tree->tPt>25;
    ...
    for (int j=0; j<27; ++j){
       ...
       if (isembedded && tree->tZTTGenMatching==5 && tree->tDecayMode==0) mymetvector[j]=mymetvector[j]+tau2-0.9980*tau2;
       else if (isembedded && tree->tZTTGenMatching==5 && tree->tDecayMode==1) mymetvector[j]=mymetvector[j]+tau2-0.9978*tau2;
       else if (isembedded && tree->tZTTGenMatching==5 && tree->tDecayMode==10) mymetvector[j]=mymetvector[j]+tau2-0.9874*tau2;
       else if (isembedded && tree->tZTTGenMatching==5 && tree->tDecayMode==11) mymetvector[j]=mymetvector[j]+tau2-0.9874*tau2;
    ...
    if (ismc && tree->tZTTGenMatching==5 && tree->tDecayMode==0) tau2=tau2*0.994;
    else if (ismc && tree->tZTTGenMatching==5 && tree->tDecayMode==1) tau2=tau2*0.995;
    else if (ismc && tree->tZTTGenMatching==5 && tree->tDecayMode==10) tau2=tau2*1.000;
    else if (ismc && tree->tZTTGenMatching==5 && tree->tDecayMode==11) tau2=tau2*1.000;
    if (isembedded && tree->tZTTGenMatching==5 && tree->tDecayMode==0) tau2=tau2*0.9980;
    else if (isembedded && tree->tZTTGenMatching==5 && tree->tDecayMode==1) tau2=tau2*0.9978;
    else if (isembedded && tree->tZTTGenMatching==5 && tree->tDecayMode==10) tau2=tau2*0.9874;
    else if (isembedded && tree->tZTTGenMatching==5 && tree->tDecayMode==11) tau2=tau2*0.9874;
    /*if (ismc && (tree->tZTTGenMatching==2 or tree->tZTTGenMatching==4) && tree->tDecayMode==0) tau2=tau2*1.000;
    else if (ismc && (tree->tZTTGenMatching==2 or tree->tZTTGenMatching==4) && tree->tDecayMode==1) tau2=tau2*0.995;
    if (ismc && (tree->tZTTGenMatching==1 or tree->tZTTGenMatching==3) && tree->tDecayMode==0) tau2=tau2*0.995;
    else if (ismc && (tree->tZTTGenMatching==1 or tree->tZTTGenMatching==3) && tree->tDecayMode==1) tau2=tau2*1.060;*/
