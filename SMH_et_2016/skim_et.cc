...
int main(int argc, char** argv) {
	...
	dau1=dau1*(tree->eCorrectedEt/dau1.E());
        ...
        else if (isMC && tree->tZTTGenMatching==5 && tree->tDecayMode==11) dau2=dau2*1.000;
        if (isEmbedded && tree->tZTTGenMatching==5 && tree->tDecayMode==0) dau2=dau2*0.9980;
        else if (isEmbedded && tree->tZTTGenMatching==5 && tree->tDecayMode==1) dau2=dau2*0.9978;
        else if (isEmbedded && tree->tZTTGenMatching==5 && tree->tDecayMode==10) dau2=dau2*0.9874;
        else if (isEmbedded && tree->tZTTGenMatching==5 && tree->tDecayMode==11) dau2=dau2*0.9874;
        if (isMC && (tree->tZTTGenMatching==1 or tree->tZTTGenMatching==3) && tree->tDecayMode==0 && fabs(dau2.Eta())<1.5) dau2=dau2*1.00679;
        else if (isMC && (tree->tZTTGenMatching==1 or tree->tZTTGenMatching==3) && tree->tDecayMode==1 && fabs(dau2.Eta())<1.5) dau2=dau2*1.03389;
        else if (isMC && (tree->tZTTGenMatching==1 or tree->tZTTGenMatching==3) && tree->tDecayMode==0 && fabs(dau2.Eta())>1.5) dau2=dau2*0.965;
        else if (isMC && (tree->tZTTGenMatching==1 or tree->tZTTGenMatching==3) && tree->tDecayMode==1 && fabs(dau2.Eta())>1.5) dau2=dau2*1.05;
        if (isMC && (tree->tZTTGenMatching==2 or tree->tZTTGenMatching==4) && tree->tDecayMode==0) dau2=dau2*1.000;
        else if (isMC && (tree->tZTTGenMatching==2 or tree->tZTTGenMatching==4) && tree->tDecayMode==1) dau2=dau2*0.995;
	...
	if (dau1.Pt()<24.5 or dau2.Pt()<29.5) continue;
