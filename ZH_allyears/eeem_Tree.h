...
void fillTree(TTree *Run_Tree, HTauTauTree_eeem *tree, int entry_tree, int recoil, bool ismc, int year){
    ...
    tau4.SetPtEtaPhiM(tree->mPt,tree->mEta,tree->mPhi,tree->mMass);
    ...
    gen_match_4=tree->mZTTGenMatching;
    ...
    dZ_4 = tree->mPVDZ;
    q_4 = tree->mCharge;
    id_m_medium_4 = tree->mPFIDMedium;
    id_m_tight_4 = tree->mPFIDTight;
    iso_4 = tree->mRelPFIsoDBDefault;
