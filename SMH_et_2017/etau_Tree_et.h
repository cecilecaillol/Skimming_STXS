...
using namespace std;
float lheweight_muR0p5_muF0p5,lheweight_muR0p5_muF1,lheweight_muR0p5_muF2,lheweight_muR1_muF0p5,lheweight_muR1_muF2,lheweight_muR2_muF0p5,lheweight_muR2_muF1,lheweight_muR2_muF2;
float PythiaWeight_fsr_muR0p25,PythiaWeight_fsr_muR0p5,PythiaWeight_fsr_muR2,PythiaWeight_fsr_muR4,PythiaWeight_isr_muR0p25,PythiaWeight_isr_muR0p5,PythiaWeight_isr_muR2,PythiaWeight_isr_muR4;
...
void fillTree(TTree *Run_Tree, HTauTauTree_et *tree, int entry_tree, int recoil, bool ismc, bool isembedded){
    ...
    njets_JetAbsoluteUp = tree->jetVeto30WoNoisyJets_JetAbsoluteUp;
    njets_JetAbsoluteDown = tree->jetVeto30WoNoisyJets_JetAbsoluteDown;
    njets_JetAbsoluteyearUp = tree->jetVeto30WoNoisyJets_JetAbsoluteyearUp;
    njets_JetAbsoluteyearDown = tree->jetVeto30WoNoisyJets_JetAbsoluteyearDown;
    njets_JetBBEC1Up = tree->jetVeto30WoNoisyJets_JetBBEC1Up;
    njets_JetBBEC1Down = tree->jetVeto30WoNoisyJets_JetBBEC1Down;
    njets_JetBBEC1yearUp = tree->jetVeto30WoNoisyJets_JetBBEC1yearUp;
    njets_JetBBEC1yearDown = tree->jetVeto30WoNoisyJets_JetBBEC1yearDown;
    njets_JetEC2Up = tree->jetVeto30WoNoisyJets_JetEC2Up;
    njets_JetEC2Down = tree->jetVeto30WoNoisyJets_JetEC2Down;
    njets_JetEC2yearUp = tree->jetVeto30WoNoisyJets_JetEC2yearUp;
    njets_JetEC2yearDown = tree->jetVeto30WoNoisyJets_JetEC2yearDown;
    njets_JetFlavorQCDUp = tree->jetVeto30WoNoisyJets_JetFlavorQCDUp;
    njets_JetFlavorQCDDown = tree->jetVeto30WoNoisyJets_JetFlavorQCDDown;
    njets_JetHFUp = tree->jetVeto30WoNoisyJets_JetHFUp;
    njets_JetHFDown = tree->jetVeto30WoNoisyJets_JetHFDown;
    njets_JetHFyearUp = tree->jetVeto30WoNoisyJets_JetHFyearUp;
    njets_JetHFyearDown = tree->jetVeto30WoNoisyJets_JetHFyearDown;
    njets_JetRelativeBalUp = tree->jetVeto30WoNoisyJets_JetRelativeBalUpWoNoisyJets;
    njets_JetRelativeBalDown = tree->jetVeto30WoNoisyJets_JetRelativeBalDownWoNoisyJets;
    ...
    njets_JERUp = tree->jetVeto30WoNoisyJets_JERUp;
    njets_JERDown = tree->jetVeto30WoNoisyJets_JERDown;
    ...
    for (int j=0; j<27; ++j){
       if (ismc && tree->tZTTGenMatching==5 && tree->tDecayMode==0) mymetvector[j]=mymetvector[j]+tau2-1.007*tau2;
       else if (ismc && tree->tZTTGenMatching==5 && tree->tDecayMode==1) mymetvector[j]=mymetvector[j]+tau2-0.998*tau2;
       else if (ismc && tree->tZTTGenMatching==5 && tree->tDecayMode==10) mymetvector[j]=mymetvector[j]+tau2-1.001*tau2;
       else if (ismc && tree->tZTTGenMatching==5 && tree->tDecayMode==11) mymetvector[j]=mymetvector[j]+tau2-0.999*tau2;
       else if (ismc && (tree->tZTTGenMatching==1 or tree->tZTTGenMatching==3) && tree->tDecayMode==0 && fabs(tau2.Eta())<1.5) mymetvector[j]=mymetvector[j]+tau2-1.00911*tau2;
       else if (ismc && (tree->tZTTGenMatching==1 or tree->tZTTGenMatching==3) && tree->tDecayMode==1 && fabs(tau2.Eta())<1.5) mymetvector[j]=mymetvector[j]+tau2-1.01154*tau2;
       else if (ismc && (tree->tZTTGenMatching==1 or tree->tZTTGenMatching==3) && tree->tDecayMode==0 && fabs(tau2.Eta())>1.5) mymetvector[j]=mymetvector[j]+tau2-0.97396*tau2;
       else if (ismc && (tree->tZTTGenMatching==1 or tree->tZTTGenMatching==3) && tree->tDecayMode==1 && fabs(tau2.Eta())>1.5) mymetvector[j]=mymetvector[j]+tau2-1.015*tau2;
       else if (ismc && (tree->tZTTGenMatching==2 or tree->tZTTGenMatching==4) && tree->tDecayMode==0) mymetvector[j]=mymetvector[j]+tau2-1.000*tau2;
       else if (ismc && (tree->tZTTGenMatching==2 or tree->tZTTGenMatching==4) && tree->tDecayMode==1) mymetvector[j]=mymetvector[j]+tau2-1.000*tau2;

       if (isembedded && tree->tZTTGenMatching==5 && tree->tDecayMode==0) mymetvector[j]=mymetvector[j]+tau2-0.9996*tau2;
       else if (isembedded && tree->tZTTGenMatching==5 && tree->tDecayMode==1) mymetvector[j]=mymetvector[j]+tau2-0.9880*tau2;
       else if (isembedded && tree->tZTTGenMatching==5 && tree->tDecayMode==10) mymetvector[j]=mymetvector[j]+tau2-0.9925*tau2;
       else if (isembedded && tree->tZTTGenMatching==5 && tree->tDecayMode==11) mymetvector[j]=mymetvector[j]+tau2-0.9925*tau2;
    }
    ...
    else if (ismc && tree->tZTTGenMatching==5 && tree->tDecayMode==11) tau2=tau2*0.999;

    if (isembedded && tree->tZTTGenMatching==5 && tree->tDecayMode==0) tau2=tau2*0.9996;
    else if (isembedded && tree->tZTTGenMatching==5 && tree->tDecayMode==1) tau2=tau2*0.9880;
    else if (isembedded && tree->tZTTGenMatching==5 && tree->tDecayMode==10) tau2=tau2*0.9925;
    else if (isembedded && tree->tZTTGenMatching==5 && tree->tDecayMode==11) tau2=tau2*0.9925;

    if (ismc && (tree->tZTTGenMatching==1 or tree->tZTTGenMatching==3) && tree->tDecayMode==0 && fabs(tau2.Eta())<1.5) tau2=tau2*1.00911;
    else if (ismc && (tree->tZTTGenMatching==1 or tree->tZTTGenMatching==3) && tree->tDecayMode==1 && fabs(tau2.Eta())<1.5) tau2=tau2*1.01154;
    else if (ismc && (tree->tZTTGenMatching==1 or tree->tZTTGenMatching==3) && tree->tDecayMode==0 && fabs(tau2.Eta())>1.5) tau2=tau2*0.974;
    else if (ismc && (tree->tZTTGenMatching==1 or tree->tZTTGenMatching==3) && tree->tDecayMode==1 && fabs(tau2.Eta())>1.5) tau2=tau2*1.015;
    ...
    if (isembedded){
      if (fabs(tau1.Eta())<1.479) tau1=tau1*0.9993;
      if (fabs(tau1.Eta())>1.479) tau1=tau1*0.9887;
    }
    m_1 = tree->eMass;
    e_1 = tau1.E();
    pt_1 = tau1.Pt();
    ...
    jpt_1_JERUp=tree->j1ptWoNoisyJets_JERUp;
    jpt_1_JERDown=tree->j1ptWoNoisyJets_JERDown;
    jpt_1_JetAbsoluteUp=tree->j1ptWoNoisyJets_JetAbsoluteUp;
    jpt_1_JetAbsoluteDown=tree->j1ptWoNoisyJets_JetAbsoluteDown;
    jpt_1_JetAbsoluteyearUp=tree->j1ptWoNoisyJets_JetAbsoluteyearUp;
    jpt_1_JetAbsoluteyearDown=tree->j1ptWoNoisyJets_JetAbsoluteyearDown;
    jpt_1_JetBBEC1Up=tree->j1ptWoNoisyJets_JetBBEC1Up;
    jpt_1_JetBBEC1Down=tree->j1ptWoNoisyJets_JetBBEC1Down;
    jpt_1_JetBBEC1yearUp=tree->j1ptWoNoisyJets_JetBBEC1yearUp;
    jpt_1_JetBBEC1yearDown=tree->j1ptWoNoisyJets_JetBBEC1yearDown;
    jpt_1_JetEC2Up=tree->j1ptWoNoisyJets_JetEC2Up;
    jpt_1_JetEC2Down=tree->j1ptWoNoisyJets_JetEC2Down;
    jpt_1_JetEC2yearUp=tree->j1ptWoNoisyJets_JetEC2yearUp;
    jpt_1_JetEC2yearDown=tree->j1ptWoNoisyJets_JetEC2yearDown;
    jpt_1_JetFlavorQCDUp=tree->j1ptWoNoisyJets_JetFlavorQCDUp;
    jpt_1_JetFlavorQCDDown=tree->j1ptWoNoisyJets_JetFlavorQCDDown;
    jpt_1_JetHFUp=tree->j1ptWoNoisyJets_JetHFUp;
    jpt_1_JetHFDown=tree->j1ptWoNoisyJets_JetHFDown;
    jpt_1_JetHFyearUp=tree->j1ptWoNoisyJets_JetHFyearUp;
    jpt_1_JetHFyearDown=tree->j1ptWoNoisyJets_JetHFyearDown;
    jpt_1_JetRelativeBalUp=tree->j1ptWoNoisyJets_JetRelativeBalUp;
    jpt_1_JetRelativeBalDown=tree->j1ptWoNoisyJets_JetRelativeBalDown;
    jpt_1_JetRelativeSampleUp=tree->j1ptWoNoisyJets_JetRelativeSampleUp;
    jpt_1_JetRelativeSampleDown=tree->j1ptWoNoisyJets_JetRelativeSampleDown;
  ...
  mjj_JERUp=tree->vbfMassWoNoisyJets_JERUp;
  mjj_JERDown=tree->vbfMassWoNoisyJets_JERDown;
  mjj_JetAbsoluteUp=tree->vbfMassWoNoisyJets_JetAbsoluteUp;
  mjj_JetAbsoluteDown=tree->vbfMassWoNoisyJets_JetAbsoluteDown;
  mjj_JetAbsoluteyearUp=tree->vbfMassWoNoisyJets_JetAbsoluteyearUp;
  mjj_JetAbsoluteyearDown=tree->vbfMassWoNoisyJets_JetAbsoluteyearDown;
  mjj_JetBBEC1Up=tree->vbfMassWoNoisyJets_JetBBEC1Up;
  mjj_JetBBEC1Down=tree->vbfMassWoNoisyJets_JetBBEC1Down;
  mjj_JetBBEC1yearUp=tree->vbfMassWoNoisyJets_JetBBEC1yearUp;
  mjj_JetBBEC1yearDown=tree->vbfMassWoNoisyJets_JetBBEC1yearDown;
  mjj_JetEC2Up=tree->vbfMassWoNoisyJets_JetEC2Up;
  mjj_JetEC2Down=tree->vbfMassWoNoisyJets_JetEC2Down;
  mjj_JetEC2yearUp=tree->vbfMassWoNoisyJets_JetEC2yearUp;
  mjj_JetEC2yearDown=tree->vbfMassWoNoisyJets_JetEC2yearDown;
  mjj_JetFlavorQCDUp=tree->vbfMassWoNoisyJets_JetFlavorQCDUp;
  mjj_JetFlavorQCDDown=tree->vbfMassWoNoisyJets_JetFlavorQCDDown;
  mjj_JetHFUp=tree->vbfMassWoNoisyJets_JetHFUp;
  mjj_JetHFDown=tree->vbfMassWoNoisyJets_JetHFDown;
  mjj_JetHFyearUp=tree->vbfMassWoNoisyJets_JetHFyearUp;
  mjj_JetHFyearDown=tree->vbfMassWoNoisyJets_JetHFyearDown;
  mjj_JetRelativeBalUp=tree->vbfMassWoNoisyJets_JetRelativeBalUp;
  mjj_JetRelativeBalDown=tree->vbfMassWoNoisyJets_JetRelativeBalDown;
  mjj_JetRelativeSampleUp=tree->vbfMassWoNoisyJets_JetRelativeSampleUp;
  mjj_JetRelativeSampleDown=tree->vbfMassWoNoisyJets_JetRelativeSampleDown;
