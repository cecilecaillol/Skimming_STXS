...
int main(int argc, char** argv) {
    ...
    Run_Tree->Branch("gen_ele_pt", &gen_ele_pt, "gen_ele_pt/F");
    Run_Tree->Branch("gen_ele_eta", &gen_ele_eta, "gen_ele_eta/F");
    Run_Tree->Branch("gen_ele_phi", &gen_ele_phi, "gen_ele_phi/F");
    ...
    Run_Tree->Branch("matchEmbFilter_Ele24Tau30_2", &matchEmbFilter_Ele24Tau30_2, "matchEmbFilter_Ele24Tau30_2/F");
    Run_Tree->Branch("matchEmbFilter_Ele27_1", &matchEmbFilter_Ele27_1, "matchEmbFilter_Ele27_1/F");
    Run_Tree->Branch("matchEmbFilter_Ele32DoubleL1v2_1", &matchEmbFilter_Ele32DoubleL1v2_1, "matchEmbFilter_Ele32DoubleL1v2_1/F");
    Run_Tree->Branch("matchEmbFilter_Ele32DoubleL1v1_1", &matchEmbFilter_Ele32DoubleL1v1_1, "matchEmbFilter_Ele32DoubleL1v1_1/F");
    Run_Tree->Branch("matchEmbFilter_Ele32_1", &matchEmbFilter_Ele32_1, "matchEmbFilter_Ele32_1/F");
    Run_Tree->Branch("matchEmbFilter_Ele35_1", &matchEmbFilter_Ele35_1, "matchEmbFilter_Ele35_1/F");
    Run_Tree->Branch("matchEmbFilter_Ele24Tau30_1", &matchEmbFilter_Ele24Tau30_1, "matchEmbFilter_Ele24Tau30_1/F");
	...
	dau1=dau1*(tree->eCorrectedEt/dau1.E());
        ...
        else if (isMC && tree->tZTTGenMatching==5 && tree->tDecayMode==11) dau2=dau2*0.999;

        if (isEmbedded && tree->tZTTGenMatching==5 && tree->tDecayMode==0) dau2=dau2*0.9996;
        else if (isEmbedded && tree->tZTTGenMatching==5 && tree->tDecayMode==1) dau2=dau2*0.9880;
        else if (isEmbedded && tree->tZTTGenMatching==5 && tree->tDecayMode==10) dau2=dau2*0.9925;
        else if (isEmbedded && tree->tZTTGenMatching==5 && tree->tDecayMode==11) dau2=dau2*0.9925;

        if (isMC && (tree->tZTTGenMatching==1 or tree->tZTTGenMatching==3) && tree->tDecayMode==0 && fabs(dau2.Eta())<1.5) dau2=dau2*1.00911;
        else if (isMC && (tree->tZTTGenMatching==1 or tree->tZTTGenMatching==3) && tree->tDecayMode==1 && fabs(dau2.Eta())<1.5) dau2=dau2*1.01154;
        else if (isMC && (tree->tZTTGenMatching==1 or tree->tZTTGenMatching==3) && tree->tDecayMode==0 && fabs(dau2.Eta())>1.5) dau2=dau2*0.97396;
        else if (isMC && (tree->tZTTGenMatching==1 or tree->tZTTGenMatching==3) && tree->tDecayMode==1 && fabs(dau2.Eta())>1.5) dau2=dau2*1.015;
	...
	if (evt_now==evt_before){
	   if (tree->eRelPFIsoRho<muiso_before or (tree->eRelPFIsoRho==muiso_before && tree->ePt>mupt_before) or (tree->eRelPFIsoRho==muiso_before && tree->ePt==mupt_before && tree->tDeepTau2017v2p1VSjetraw>tauiso_before) or (tree->eRelPFIsoRho==muiso_before && tree->ePt==mupt_before && tree->tDeepTau2017v2p1VSjetraw==tauiso_before && tree->tPt>taupt_before) ){
		bestEntry=iEntry;
	        muiso_before=tree->eRelPFIsoRho;
		mupt_before=tree->ePt;
		tauiso_before=tree->tDeepTau2017v2p1VSjetraw;
