...
// Thu May 21 12:57:01 2020 by ROOT version 6.10/09
...
#ifndef HTauTauTree_mmet_h
#define HTauTauTree_mmet_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   // methods
   HTauTauTree_mmet (TTree* tree); //ctor
   ~HTauTauTree_mmet();
...
HTauTauTree_mmet::HTauTauTree_mmet (TTree* tree)
{
    Init(tree);
}

HTauTauTree_mmet::~HTauTauTree_mmet() {}

void HTauTauTree_mmet::Init(TTree* tree)
{
   // Set object pointer
...
Int_t HTauTauTree_mmet::GetEntry(int entry)
{
    return _tree->GetEntry(entry);
}

Long64_t HTauTauTree_mmet::GetEntries()
{
    return _tree->GetEntries();
}

TTree* HTauTauTree_mmet::GetTree()
{
    return _tree;
}
