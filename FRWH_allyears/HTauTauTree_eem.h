...
// Thu Dec 19 02:42:56 2019 by ROOT version 6.10/09
...
#ifndef HTauTauTree_eem_h
#define HTauTauTree_eem_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   // methods
   HTauTauTree_eem (TTree* tree); //ctor
   ~HTauTauTree_eem();
...
HTauTauTree_eem::HTauTauTree_eem (TTree* tree)
{
    Init(tree);
}

HTauTauTree_eem::~HTauTauTree_eem() {}

void HTauTauTree_eem::Init(TTree* tree)
{
   // Set object pointer
...
Int_t HTauTauTree_eem::GetEntry(int entry)
{
    return _tree->GetEntry(entry);
}

Long64_t HTauTauTree_eem::GetEntries()
{
    return _tree->GetEntries();
}

TTree* HTauTauTree_eem::GetTree()
{
    return _tree;
}
