...
// Thu Dec 19 02:44:00 2019 by ROOT version 6.10/09
...
#ifndef HTauTauTree_ett_h
#define HTauTauTree_ett_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         e_t1_DR;
   Float_t         e_t1_Mass;
   Float_t         e_t1_doubleL1IsoTauMatch;
   Float_t         e_t2_DR;
   Float_t         e_t2_Mass;
   Float_t         e_t2_doubleL1IsoTauMatch;
   ...
   TBranch        *b_e_t1_DR;   //!
   TBranch        *b_e_t1_Mass;   //!
   TBranch        *b_e_t1_doubleL1IsoTauMatch;   //!
   TBranch        *b_e_t2_DR;   //!
   TBranch        *b_e_t2_Mass;   //!
   TBranch        *b_e_t2_doubleL1IsoTauMatch;   //!
   ...
   // methods
   HTauTauTree_ett (TTree* tree); //ctor
   ~HTauTauTree_ett();
...
HTauTauTree_ett::HTauTauTree_ett (TTree* tree)
{
    Init(tree);
}

HTauTauTree_ett::~HTauTauTree_ett() {}

void HTauTauTree_ett::Init(TTree* tree)
{
   // Set object pointer
   ...
   _tree->SetBranchAddress("e_t1_DR", &e_t1_DR, &b_e_t1_DR);
   _tree->SetBranchAddress("e_t1_Mass", &e_t1_Mass, &b_e_t1_Mass);
   _tree->SetBranchAddress("e_t1_doubleL1IsoTauMatch", &e_t1_doubleL1IsoTauMatch, &b_e_t1_doubleL1IsoTauMatch);
   _tree->SetBranchAddress("e_t2_DR", &e_t2_DR, &b_e_t2_DR);
   _tree->SetBranchAddress("e_t2_Mass", &e_t2_Mass, &b_e_t2_Mass);
   _tree->SetBranchAddress("e_t2_doubleL1IsoTauMatch", &e_t2_doubleL1IsoTauMatch, &b_e_t2_doubleL1IsoTauMatch);
...
Int_t HTauTauTree_ett::GetEntry(int entry)
{
    return _tree->GetEntry(entry);
}

Long64_t HTauTauTree_ett::GetEntries()
{
    return _tree->GetEntries();
}

TTree* HTauTauTree_ett::GetTree()
{
    return _tree;
}
