...
// Thu Dec 19 02:43:44 2019 by ROOT version 6.10/09
...
#ifndef HTauTauTree_emt_h
#define HTauTauTree_emt_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   // methods
   HTauTauTree_emt (TTree* tree); //ctor
   ~HTauTauTree_emt();
...
HTauTauTree_emt::HTauTauTree_emt (TTree* tree)
{
    Init(tree);
}

HTauTauTree_emt::~HTauTauTree_emt() {}

void HTauTauTree_emt::Init(TTree* tree)
{
   // Set object pointer
...
Int_t HTauTauTree_emt::GetEntry(int entry)
{
    return _tree->GetEntry(entry);
}

Long64_t HTauTauTree_emt::GetEntries()
{
    return _tree->GetEntries();
}

TTree* HTauTauTree_emt::GetTree()
{
    return _tree;
}
