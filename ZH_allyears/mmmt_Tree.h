...
float matchMu24_3,filterMu24_3,matchMu27_3,filterMu27_3,matchMu22eta2p1_3,matchTkMu22eta2p1_3,matchMu22_3,matchTkMu22_3,filterMu22eta2p1_3,filterTkMu22eta2p1_3,filterMu22_3,filterTkMu22_3;
...
void fillTree(TTree *Run_Tree, HTauTauTree_mmmt *tree, int entry_tree, int recoil, bool ismc, int year){
    ...
    tau3.SetPtEtaPhiM(tree->m3Pt,tree->m3Eta,tree->m3Phi,tree->m3Mass);
    ...
    float m13=10000;
    if (tree->m1Charge*tree->m3Charge<0) m13=(tau1+tau3).M();
    float m23=10000;
    if (tree->m2Charge*tree->m3Charge<0) m23=(tau2+tau3).M();
    ...
    if (is_taudecay==1){
      ...
      tau3.SetPtEtaPhiM(tree->m1Pt,tree->m1Eta,tree->m1Phi,tree->m1Mass);
    }
    if (is_taudecay==2){
      tau1.SetPtEtaPhiM(tree->m1Pt,tree->m1Eta,tree->m1Phi,tree->m1Mass);
      tau2.SetPtEtaPhiM(tree->m3Pt,tree->m3Eta,tree->m3Phi,tree->m3Mass);
    ...
    if (is_taudecay==3){
       ...
       q_3 = tree->m3Charge;
       id_m_medium_3 = tree->m3PFIDMedium;
       id_m_tight_3 = tree->m3PFIDTight;
       iso_3 = tree->m3RelPFIsoDBDefault;
       gen_match_3=tree->m3ZTTGenMatching;
       matchMu24_3=tree->m3MatchesIsoMu24Path;
       filterMu24_3=tree->m3MatchesIsoMu24Filter;
       matchMu27_3=tree->m3MatchesIsoMu27Path;
       filterMu27_3=tree->m3MatchesIsoMu27Filter;
       matchMu22eta2p1_3=tree->m3MatchesIsoMu22eta2p1Path;
       matchTkMu22eta2p1_3=tree->m3MatchesIsoTkMu22eta2p1Path;
       matchMu22_3=tree->m3MatchesIsoMu22Path;
       matchTkMu22_3=tree->m3MatchesIsoTkMu22Path;
       filterMu22eta2p1_3=tree->m3MatchesIsoMu22eta2p1Filter;
       filterTkMu22eta2p1_3=tree->m3MatchesIsoTkMu22eta2p1Filter;
       filterMu22_3=tree->m3MatchesIsoMu22Filter;
       filterTkMu22_3=tree->m3MatchesIsoTkMu22Filter;
    }
    ...
    if (is_taudecay==2){
       ...
       matchMu22_3=tree->m2MatchesIsoMu22Path;
       matchTkMu22_3=tree->m2MatchesIsoTkMu22Path;
       filterMu22eta2p1_3=tree->m2MatchesIsoMu22eta2p1Filter;
       filterTkMu22eta2p1_3=tree->m2MatchesIsoTkMu22eta2p1Filter;
       filterMu22_3=tree->m2MatchesIsoMu22Filter;
       filterTkMu22_3=tree->m2MatchesIsoTkMu22Filter;
    }
    if (is_taudecay==1){
       q_1 = tree->m2Charge;
       ...
       q_3 = tree->m1Charge;
       id_m_medium_3 = tree->m1PFIDMedium;
       id_m_tight_3 = tree->m1PFIDTight;
       iso_3 = tree->m1RelPFIsoDBDefault;
       gen_match_3=tree->m1ZTTGenMatching;
       matchMu24_3=tree->m1MatchesIsoMu24Path;
       filterMu24_3=tree->m1MatchesIsoMu24Filter;
       matchMu27_3=tree->m1MatchesIsoMu27Path;
       filterMu27_3=tree->m1MatchesIsoMu27Filter;
       matchMu22eta2p1_3=tree->m1MatchesIsoMu22eta2p1Path;
       matchTkMu22eta2p1_3=tree->m1MatchesIsoTkMu22eta2p1Path;
       matchMu22_3=tree->m1MatchesIsoMu22Path;
       matchTkMu22_3=tree->m1MatchesIsoTkMu22Path;
       filterMu22eta2p1_3=tree->m1MatchesIsoMu22eta2p1Filter;
       filterTkMu22eta2p1_3=tree->m1MatchesIsoTkMu22eta2p1Filter;
       filterMu22_3=tree->m1MatchesIsoMu22Filter;
       filterTkMu22_3=tree->m1MatchesIsoTkMu22Filter;
    }
