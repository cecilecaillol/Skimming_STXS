...
int main(int argc, char** argv) {
    ...
    for (int iEntry = 0; iEntry < tree->GetEntries() ; iEntry++)
    {
        ...
        if (isMC && tree->t2ZTTGenMatching==5 && tree->t2DecayMode==0) dau2=dau2*1.007;
        else if (isMC && tree->t2ZTTGenMatching==5 && tree->t2DecayMode==1) dau2=dau2*0.998;
        else if (isMC && tree->t2ZTTGenMatching==5 && tree->t2DecayMode==10) dau2=dau2*1.001;
        ...
        if (isMC && tree->t1ZTTGenMatching==5 && tree->t1DecayMode==0) dau1=dau1*1.007;
        else if (isMC && tree->t1ZTTGenMatching==5 && tree->t1DecayMode==1) dau1=dau1*0.998;
        else if (isMC && tree->t1ZTTGenMatching==5 && tree->t1DecayMode==10) dau1=dau1*1.001;
