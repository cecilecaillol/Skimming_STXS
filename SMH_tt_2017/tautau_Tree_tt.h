...
void fillTree(TTree *Run_Tree, HTauTauTree_tt *tree, int entry_tree, int recoil, bool ismc, int reorder){
    ...
    if (ismc && tree->t1ZTTGenMatching==5 && tree->t1DecayMode==0){
        mymet=mymet+tau1-1.007*tau1;
        mymet_UESDown=mymet_UESDown+tau1-1.007*tau1;
        mymet_UESUp=mymet_UESUp+tau1-1.007*tau1;
        mymet_JetEta0to3Up=mymet_JetEta0to3Up+tau1-1.007*tau1;
        mymet_JetEta0to3Down=mymet_JetEta0to3Down+tau1-1.007*tau1;
        mymet_JetEC2Up=mymet_JetEC2Up+tau1-1.007*tau1;
        mymet_JetEC2Down=mymet_JetEC2Down+tau1-1.007*tau1;
        mymet_JetRelativeSampleUp=mymet_JetRelativeSampleUp+tau1-1.007*tau1;
        mymet_JetRelativeSampleDown=mymet_JetRelativeSampleDown+tau1-1.007*tau1;
        mymet_JetEta3to5Up=mymet_JetEta3to5Up+tau1-1.007*tau1;
        mymet_JetEta3to5Down=mymet_JetEta3to5Down+tau1-1.007*tau1;
        mymet_JetRelativeBalUp=mymet_JetRelativeBalUp+tau1-1.007*tau1;
        mymet_JetRelativeBalDown=mymet_JetRelativeBalDown+tau1-1.007*tau1;
        mymet_JetEta0to5Up=mymet_JetEta0to5Up+tau1-1.007*tau1;
        mymet_JetEta0to5Down=mymet_JetEta0to5Down+tau1-1.007*tau1;
    }
    else if (ismc && tree->t1ZTTGenMatching==5 && tree->t1DecayMode==1){
        mymet=mymet+tau1-0.998*tau1;
        mymet_UESDown=mymet_UESDown+tau1-0.998*tau1;
        mymet_UESUp=mymet_UESUp+tau1-0.998*tau1;
        mymet_JetEta0to3Up=mymet_JetEta0to3Up+tau1-0.998*tau1;
        mymet_JetEta0to3Down=mymet_JetEta0to3Down+tau1-0.998*tau1;
        mymet_JetEC2Up=mymet_JetEC2Up+tau1-0.998*tau1;
        mymet_JetEC2Down=mymet_JetEC2Down+tau1-0.998*tau1;
        mymet_JetRelativeSampleUp=mymet_JetRelativeSampleUp+tau1-0.998*tau1;
        mymet_JetRelativeSampleDown=mymet_JetRelativeSampleDown+tau1-0.998*tau1;
        mymet_JetEta3to5Up=mymet_JetEta3to5Up+tau1-0.998*tau1;
        mymet_JetEta3to5Down=mymet_JetEta3to5Down+tau1-0.998*tau1;
        mymet_JetRelativeBalUp=mymet_JetRelativeBalUp+tau1-0.998*tau1;
        mymet_JetRelativeBalDown=mymet_JetRelativeBalDown+tau1-0.998*tau1;
        mymet_JetEta0to5Up=mymet_JetEta0to5Up+tau1-0.998*tau1;
        mymet_JetEta0to5Down=mymet_JetEta0to5Down+tau1-0.998*tau1;
    }
    else if (ismc && tree->t1ZTTGenMatching==5 && tree->t1DecayMode==10){
        mymet=mymet+tau1-1.001*tau1;
        mymet_UESDown=mymet_UESDown+tau1-1.001*tau1;
        mymet_UESUp=mymet_UESUp+tau1-1.001*tau1;
        mymet_JetEta0to3Up=mymet_JetEta0to3Up+tau1-1.001*tau1;
        mymet_JetEta0to3Down=mymet_JetEta0to3Down+tau1-1.001*tau1;
        mymet_JetEC2Up=mymet_JetEC2Up+tau1-1.001*tau1;
        mymet_JetEC2Down=mymet_JetEC2Down+tau1-1.001*tau1;
        mymet_JetRelativeSampleUp=mymet_JetRelativeSampleUp+tau1-1.001*tau1;
        mymet_JetRelativeSampleDown=mymet_JetRelativeSampleDown+tau1-1.001*tau1;
        mymet_JetEta3to5Up=mymet_JetEta3to5Up+tau1-1.001*tau1;
        mymet_JetEta3to5Down=mymet_JetEta3to5Down+tau1-1.001*tau1;
        mymet_JetRelativeBalUp=mymet_JetRelativeBalUp+tau1-1.001*tau1;
        mymet_JetRelativeBalDown=mymet_JetRelativeBalDown+tau1-1.001*tau1;
        mymet_JetEta0to5Up=mymet_JetEta0to5Up+tau1-1.001*tau1;
        mymet_JetEta0to5Down=mymet_JetEta0to5Down+tau1-1.001*tau1;
    }
    ...
    if (ismc && tree->t1ZTTGenMatching==5 && tree->t1DecayMode==0) tau1=tau1*1.007;
    else if (ismc && tree->t1ZTTGenMatching==5 && tree->t1DecayMode==1) tau1=tau1*0.998;
    else if (ismc && tree->t1ZTTGenMatching==5 && tree->t1DecayMode==10) tau1=tau1*1.001;
    if (ismc && tree->t2ZTTGenMatching==5 && tree->t2DecayMode==0) tau2=tau2*1.007;
    else if (ismc && tree->t2ZTTGenMatching==5 && tree->t2DecayMode==1) tau2=tau2*0.998;
    else if (ismc && tree->t2ZTTGenMatching==5 && tree->t2DecayMode==10) tau2=tau2*1.001;
