...
void fillTree(TTree *Run_Tree, HTauTauTree_ett *tree, int entry_tree, int recoil, bool ismc, int year){
    ...
    dZ_3 = tree->t2PVDZ;
    d0_3=tree->t2PVDXY;
    iso_3=tree->t2ByIsolationMVArun2v1DBoldDMwLTraw;
    q_3 = tree->t2Charge;
    trackpt_3=tree->t2LeadTrackPt;
    numGenJets=tree->numGenJets;
    jetPt_3=tree->t2JetPt;
    byIsolationMVA3oldDMwoLTraw_3=tree->t2ByIsolationMVArun2v1DBoldDMwLTraw;
