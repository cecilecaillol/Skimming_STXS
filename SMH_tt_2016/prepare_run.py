...
#    datatype="data"
#    name=[
#"data_Tau_Run2016B_v1","DataBv1","0",
#"data_Tau_Run2016B_v2","DataBv2","0",
#"data_Tau_Run2016C","DataC","0",
#"data_Tau_Run2016D","DataD","0",
#"data_Tau_Run2016E","DataE","0",
#"data_Tau_Run2016F","DataF","0",
#"data_Tau_Run2016G","DataG","0",
#"data_Tau_Run2016H","DataH","0"
#]

    place="/hdfs/store/user/aloeliger/SMHTT_2016_embedded_18sep/"
    datatype="data"
    name=[
"embedded_EmbeddingRun2016B_TauTauFinalState","embeddedB","0",
"embedded_EmbeddingRun2016C_TauTauFinalState","embeddedC","0",
"embedded_EmbeddingRun2016D_TauTauFinalState","embeddedD","0",
"embedded_EmbeddingRun2016E_TauTauFinalState","embeddedE","0",
"embedded_EmbeddingRun2016F_TauTauFinalState","embeddedF","0",
"embedded_EmbeddingRun2016G_TauTauFinalState","embeddedG","0",
"embedded_EmbeddingRun2016H_TauTauFinalState","embeddedH","0"
]
...
#    place="/hdfs/store/user/aloeliger/SMHTT_2016_18Sep_HighMem_tt/"
#    datatype="mc"
#    name=[
...
#]
    ...
    datadir="/nfs_scratch/caillol/smhtt2016_12oct/"
    ...
    for j in range(0,len(name)/3):
	   ...
	   command1=command1+"./skim_tt.exe "+datatype + " " +datadir+"Out_"+name[3*j+1]+"/"+name[3*j+1]+str(ligne)+".root " + i[0:-1] + " " + name[3*j+2] +"\n"
           ligne=ligne+1
