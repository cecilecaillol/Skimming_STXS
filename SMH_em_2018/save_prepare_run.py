...
if __name__ == "__main__":
    ...
    place="/hdfs/store/user/caillol/SMHTT_legacy_2018_data_24042019/"
    name=[
...
#    place="/hdfs/store/user/caillol/SMHTT_legacy_2018_240419/"
#    name=[
...
#]
    ...
    datadir="/nfs_scratch/caillol/smhem2018_23may/"
    ...
    for j in range(0,len(name)/3):
	   ...
	   command1=command1+"./skim_em.exe data "+datadir+"Out_"+name[3*j+1]+"/"+name[3*j+1]+str(ligne)+".root " + i[0:-1] + " " + name[3*j+2] +"\n"
           ligne=ligne+1
