...
// Thu May 21 12:56:08 2020 by ROOT version 6.10/09
...
#ifndef HTauTauTree_eemt_h
#define HTauTauTree_eemt_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   // methods
   HTauTauTree_eemt (TTree* tree); //ctor
   ~HTauTauTree_eemt();
...
HTauTauTree_eemt::HTauTauTree_eemt (TTree* tree)
{
    Init(tree);
}

HTauTauTree_eemt::~HTauTauTree_eemt() {}

void HTauTauTree_eemt::Init(TTree* tree)
{
   // Set object pointer
...
Int_t HTauTauTree_eemt::GetEntry(int entry)
{
    return _tree->GetEntry(entry);
}

Long64_t HTauTauTree_eemt::GetEntries()
{
    return _tree->GetEntries();
}

TTree* HTauTauTree_eemt::GetTree()
{
    return _tree;
}
