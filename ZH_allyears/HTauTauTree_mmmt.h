...
// Thu May 21 12:57:16 2020 by ROOT version 6.10/09
...
#ifndef HTauTauTree_mmmt_h
#define HTauTauTree_mmmt_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         m3_t_DR;
   Float_t         m3_t_Mass;
   Float_t         m3_t_doubleL1IsoTauMatch;
   Float_t         metSig;
   Float_t         metcov00;
   Float_t         metcov01;
   Float_t         metcov10;
   ...
   TBranch        *b_m3_t_DR;   //!
   TBranch        *b_m3_t_Mass;   //!
   TBranch        *b_m3_t_doubleL1IsoTauMatch;   //!
   TBranch        *b_metSig;   //!
   TBranch        *b_metcov00;   //!
   TBranch        *b_metcov01;   //!
   TBranch        *b_metcov10;   //!
   ...
   // methods
   HTauTauTree_mmmt (TTree* tree); //ctor
   ~HTauTauTree_mmmt();
...
HTauTauTree_mmmt::HTauTauTree_mmmt (TTree* tree)
{
    Init(tree);
}

HTauTauTree_mmmt::~HTauTauTree_mmmt() {}

void HTauTauTree_mmmt::Init(TTree* tree)
{
   // Set object pointer
   ...
   _tree->SetBranchAddress("m3_t_DR", &m3_t_DR, &b_m3_t_DR);
   _tree->SetBranchAddress("m3_t_Mass", &m3_t_Mass, &b_m3_t_Mass);
   _tree->SetBranchAddress("m3_t_doubleL1IsoTauMatch", &m3_t_doubleL1IsoTauMatch, &b_m3_t_doubleL1IsoTauMatch);
...
Int_t HTauTauTree_mmmt::GetEntry(int entry)
{
    return _tree->GetEntry(entry);
}

Long64_t HTauTauTree_mmmt::GetEntries()
{
    return _tree->GetEntries();
}

TTree* HTauTauTree_mmmt::GetTree()
{
    return _tree;
}
