...
void fillTree(TTree *Run_Tree, HTauTauTree_tt *tree, int entry_tree, int recoil, bool ismc, int reorder){
    ...
    if (ismc && tree->t2ZTTGenMatching==5 && tree->t2DecayMode==0){
        ...
        mymet_JetEta0to3Up=mymet_JetEta0to3Up+tau2-0.987*tau2;
        mymet_JetEta0to3Down=mymet_JetEta0to3Down+tau2-0.987*tau2;
        mymet_JetEC2Up=mymet_JetEC2Up+tau2-0.987*tau2;
        mymet_JetEC2Down=mymet_JetEC2Down+tau2-0.987*tau2;
        mymet_JetRelativeSampleUp=mymet_JetRelativeSampleUp+tau2-0.987*tau2;
        mymet_JetRelativeSampleDown=mymet_JetRelativeSampleDown+tau2-0.987*tau2;
        mymet_JetEta3to5Up=mymet_JetEta3to5Up+tau2-0.987*tau2;
        mymet_JetEta3to5Down=mymet_JetEta3to5Down+tau2-0.987*tau2;
        mymet_JetRelativeBalUp=mymet_JetRelativeBalUp+tau2-0.987*tau2;
        mymet_JetRelativeBalDown=mymet_JetRelativeBalDown+tau2-0.987*tau2;
        ...
        mymet_JetEta0to3Up=mymet_JetEta0to3Up+tau2-0.988*tau2;
        mymet_JetEta0to3Down=mymet_JetEta0to3Down+tau2-0.988*tau2;
        mymet_JetEC2Up=mymet_JetEC2Up+tau2-0.988*tau2;
        mymet_JetEC2Down=mymet_JetEC2Down+tau2-0.988*tau2;
        mymet_JetRelativeSampleUp=mymet_JetRelativeSampleUp+tau2-0.988*tau2;
        mymet_JetRelativeSampleDown=mymet_JetRelativeSampleDown+tau2-0.988*tau2;
        mymet_JetEta3to5Up=mymet_JetEta3to5Up+tau2-0.988*tau2;
        mymet_JetEta3to5Down=mymet_JetEta3to5Down+tau2-0.988*tau2;
        mymet_JetRelativeBalUp=mymet_JetRelativeBalUp+tau2-0.988*tau2;
        mymet_JetRelativeBalDown=mymet_JetRelativeBalDown+tau2-0.988*tau2;
