...
int main(int argc, char** argv) {
    ...
    Run_Tree->Branch("deepVVVLooseVSmu_3", &deepVVVLooseVSmu_3, "deepVVVLooseVSmu_3/F");
    Run_Tree->Branch("deepVVLooseVSmu_3", &deepVVLooseVSmu_3, "deepVVLooseVSmu_3/F");
	...
	if (dau1.Pt()<19.5 and dau2.Pt()<19.5) continue;
